...
EOF;
        ...
        return <<<'EOF'
            ...
            table { background: #FFF; border: 1px solid #181b2e; box-shadow: 0px 0px 1px rgba(128, 128, 128, .2); margin: 1em 0; width: 100%; }
            table th, table td { border: solid #181b2e; border-width: 1px 0; padding: 8px 10px; }
            table th { background-color: #181b2e; font-weight: bold; text-align: left; }
